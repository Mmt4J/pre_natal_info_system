...
<head>
  ...
  <style>
    .content-wrapper{
      background-image: linear-gradient(rgba(4,9,30,0.7), rgba(4,9,30,0.7)),url(../assets/images/banner1.jpg);
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="login" method="post">
                ...
                <div class="form-group">
                  <input type="submit" class="form-control form-control-lg" name="login">
                </div>
